...
//         const res = await fetch('/api/studentadmission', {
...
//         setMessage(data.success ? 'Student added!' : 'Error adding student');
//         setForm({ 
//                 firstname: '',    lastname: '',    date_of_birth: '' ,   grade: '' ,  myimg:'',   
//                 gender:'',        religion: '',    language:'' ,         address:'',
//                 fathername: '',   mothername: '',  father_contact:'',    mother_contact:'', 
...
//             reader.onloadend = () => {
//                 setForm(prevForm => ({ ...prevForm,  myimg: reader.result as string, })); // base64 string
//             }; 
...
//                             </div>
//                             {/* <div className="border-2 border-black w-60 h-60 flex flex-col">
//                                 <div className="relative w-full h-52 flex items-center justify-center bg-gray-200 overflow-hidden">
//                                     {imagePreview ? (   <Image  src={imagePreview}   alt="Preview"
//                                         className="object-contain rounded"    width={150}    height={150}   />
//                                         ) : (
//                                         <p className="text-sm text-gray-600">No image selected</p>
//                                     )}
//                                 </div>
...
// //                             <div className=" border-2 border-black w-60 h-96  flex-column ">
...
// //                                     // <Image  className="object-contain rounded"
// //                                     //     src={imagePreview}  alt="Preview"  width={120}  height={150}  />
